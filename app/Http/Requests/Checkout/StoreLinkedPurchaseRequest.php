...
use App\Models\LinkedPurchase;
use Illuminate\Validation\Rule;
use App\Http\Requests\FormRequest;

class StoreLinkedPurchaseRequest extends FormRequest
{
    use RegisterRules,
        PaymentRules;
     ...
     * @var string
     */
    protected $type = LinkedPurchase::class;
    ...
    public function rules()
    {
        return array_merge($this->registerRules(), $this->paymentRules(), [
            'payment_method' => ['required', Rule::in(['payment_profile', 'credit_card', 'debit_card', 'bank_transfer', 'pix'])],
