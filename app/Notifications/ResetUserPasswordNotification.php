...
class ResetUserPasswordNotification extends ResetPassword implements ShouldQueue
{
    use Queueable;
    ...
    /**
     * ResetUserPasswordNotification constructor.
     */
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->action(__('Alterar Senha'), url(config('app.url').route('web.admin.password.reset', $this->token, false)))
